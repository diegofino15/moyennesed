          ...
          children: [
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: const [
                        Icon(FluentIcons.person_24_filled, size: 35.0),
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(
                        height: 25.0,
                        child: provider.isGettingGrades ? const LoadingAnim() : provider.gotGrades ? GestureDetector(onTap: () => handleChangePeriodPopup(context), child: const Icon(FluentIcons.arrow_bidirectional_up_down_24_filled, size: 25.0)) : Container(),
                      ),
                    ],
                  ),
                  const Gap(20.0),
                    ...
                    child: Column(
                      children: [
                        provider.gotGrades
                          ...
                          : const Text("--", style: Styles.numberTextStyle),
                        const Gap(5.0),
                        const Text("MOYENNE GÉNÉRALE", style: Styles.itemTextStyle),
                      ],
                    ),
                  ),
                  const Gap(20.0),
                  const Text("Dernières notes", style: Styles.itemTitleTextStyle),
                  const Gap(10.0),
                  SizedBox(
            ...
            BoxWidget(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text("Moyennes par matière", style: Styles.itemTitleTextStyle),
                  Column(
